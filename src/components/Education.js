      ...
      <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        ...
        <ul className="flex flex-col items-start justify-between w-full ml-4">
          <Details
            ...
            time="2020-2026"
            place="Indian Institute of Information Technology, Nagpur (IIITN)"
            info="Relevant courses included Data Structures and Algorithms, Computer Systems Engineering, and Machine Learning."
          />
          ...
          <Details
            ...
            time="2018-2020"
            place="Malkapur, Maharashtra"
            info="Completed 11th and 12th grades in the Science stream, achieving an impressive overall score of 88%, with a strong focus on core subjects like Physics, Chemistry, Mathematics, and Biology, laying a solid foundation for analytical and problem-solving skills."
          />
        </ul>
      </div>
    </div>
