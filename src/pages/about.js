          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="flex flex-col items-start justify-start col-span-3 xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="font-medium">
                Hi, I&apos;m <strong>Pratik</strong>, a B.Tech student in Computer Science at <strong>IIIT Nagpur</strong>, passionate about software development and creating user-centric digital solutions. With a strong foundation in programming and design, I specialize in building functional, innovative, and visually appealing applications.
              </p>
              <p className="my-4 font-medium">
                I believe software development is not just about writing code—it&apos;s about solving real-world problems and delivering intuitive experiences. Whether it&apos;s developing web applications, mobile apps, or exploring emerging technologies, I bring dedication and a user-focused approach to every project.
              </p>
              <p className="font-medium">
                I&apos;m excited to continue learning, growing, and contributing to impactful projects that make a difference. I look forward to bringing my skills and passion to your next challenge.
              </p>
